        ...
        <main class="flex-shrink-0">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <div class="container px-5">
                    <a class="navbar-brand" href="index.html">Berita Prodi KSI</a>
                ...
                <div class="row row-cols-1 row-cols-md-3 g-4">
                    <div class="col mb-5">
                        <div class="card h-100">
                            <img src="{{ asset('image/pp.jpg') }}" class="card-img-top" alt="" width="450" height="350">
                            <div class="card-body">
                    ...
                    <div class="col mb-5">
                        ...
                        <img src="{{ asset('image/back.jpg') }}" class="card-img-top" alt="" width="450" height="350">
                    ...
                    <div class="col mb-5">
                        <div class="card h-100 text-end">
                            <img src="{{ asset('image/img.jpg') }}" class="card-img-top" alt="" width="450" height="350">
                            <div class="card-body">
