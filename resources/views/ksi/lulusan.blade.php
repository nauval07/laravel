...
<body class="d-flex flex-column h-100">
        ...
        <div class="p-5 mb-4 bg-light rounded-3">
            <div class="container-fluid py-5">
                <h1 class="display-6 fw-bold">Selamat Datang di Halaman Profile Lulusan Prodi KSI</h1>
                <p class="col-md-8 fs-4">Dapatkan informasi terupdate dari Program Studi Keamanan Sistem Informasi dan jangan lewatkan kesempatan untuk melihat Profile lulusan di program studi ini.</p>
                ...
                <div class="row row-cols-1 row-cols-md-3 g-4">
                    <div class="col mb-5">
                        <div class="card h-100">
                            <img src="{{ asset('image/photo.jpg') }}" class="card-img-top" alt="" width="450" height="350">
                            <div class="card-body">
                    ...
                    <div class="col mb-5">
                        ...
                        <img src="{{ asset('image/profile.jpg') }}" class="card-img-top" alt="" width="450" height="350">
                    ...
                    <div class="col mb-5">
                        <div class="card h-100 text-end">
                            <img src="{{ asset('image/wall.jpg') }}" class="card-img-top" alt="" width="450" height="350">
                            <div class="card-body">
